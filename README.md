...
※ここでいうトレーニーとは、ダイエット・筋力アップトレーニングをする人を想定しています
...
私はトレーニングが趣味です。<br>
ですが、以前までは少しトレーニングをしても、気付いたら何週間もジムへ行かなかったりと継続的なトレーニングができませんでした。

なぜ継続ができなかったのでしょうか？

それは、**「結果が見えていなかった」からです！**<br>
トレーニングは結果が目に見えて現れるまでに時間がかかりますが、結果がでるまでに挫折してしまうのです。<br>
逆に結果が目に見えて現れてくると、辛かったトレーニングにも楽しみを感じることができます！

この経験を踏まえ、簡単に自分のトレーニングの成果を確認することができれば、<br>
多くの方のトレーニング・ダイエット等のサポートができると考えました！
...
このアプリケーションでは、「簡単に入力」・「すぐに確認ができる」ことを意識して作成をしました。<br>
その為、入力する内容は最低限とし、必要に応じて一言メモのような形で記録ができるようにしています。
